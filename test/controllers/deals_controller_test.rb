...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { credit_sum: @deal.credit_sum, description: @deal.description } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { credit_sum: @deal.credit_sum, description: @deal.description } }
